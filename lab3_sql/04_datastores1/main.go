...
Program: database/sql and jmoiron/sqlx demo
Author: Nicholas M. Boers

This program demonstrates the use of database/sql and jmoiron/sqlx
with City of Edmonton assessment data.
*/
package main
...
import (
	...
	// ONE of the following lines must be a comment
	//demo "./vanilla"
	//demo "./sqlx"
